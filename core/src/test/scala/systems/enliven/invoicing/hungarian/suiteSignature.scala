...
import systems.enliven.invoicing.hungarian.generated.{CREATE, InvoiceOperationListType, InvoiceOperationType, MODIFY}

class suiteSignature extends invoicingSuite {
  protected val api: Api =
    new Api(Some("ce-8f5e-215119fa7dd621DLMRHRLH2S"))(configuration, invoicing.classicSystem, invoicing.executionContext)
